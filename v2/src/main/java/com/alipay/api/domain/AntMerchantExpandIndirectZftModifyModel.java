 ...
 *
 * @author auto create
 * @since 1.0, 2026-05-12 15:34:49
 */
public class AntMerchantExpandIndirectZftModifyModel extends AlipayObject {

	private static final long serialVersionUID = 1696717156453321627L;
	...
	/**
	 * 商户使用服务，可选值有：当面付、jsapi支付、app支付、wap支付、电脑支付、预授权支付、商户代扣、小程序支付、订单码支付、线上资金预授权、新当面资金授权。其值会影响其他字段必填性，详见其他字段描述
	 */
