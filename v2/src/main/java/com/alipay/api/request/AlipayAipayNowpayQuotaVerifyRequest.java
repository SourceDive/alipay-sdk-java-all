...
public class AlipayAipayNowpayQuotaVerifyRequest implements AlipayRequest<AlipayAipayNowpayQuotaVerifyResponse> {
	...
	* 直接核销次数/积分
	...
	public String getApiMethodName() {
		return "alipay.aipay.nowpay.quota.verify";
	}
	...
	public Class<AlipayAipayNowpayQuotaVerifyResponse> getResponseClass() {
		return AlipayAipayNowpayQuotaVerifyResponse.class;
	}
