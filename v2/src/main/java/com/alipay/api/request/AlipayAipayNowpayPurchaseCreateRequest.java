...
public class AlipayAipayNowpayPurchaseCreateRequest implements AlipayRequest<AlipayAipayNowpayPurchaseCreateResponse> {
	...
	* 获取指定档位购买链接
	...
	public String getApiMethodName() {
		return "alipay.aipay.nowpay.purchase.create";
	}
	...
	public Class<AlipayAipayNowpayPurchaseCreateResponse> getResponseClass() {
		return AlipayAipayNowpayPurchaseCreateResponse.class;
	}
