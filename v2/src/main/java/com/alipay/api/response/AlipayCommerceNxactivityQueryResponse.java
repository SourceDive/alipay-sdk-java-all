...
import com.alipay.api.domain.NxActivityVoucherInfo;

import com.alipay.api.AlipayResponse;

/**
 * ALIPAY API: alipay.commerce.nxactivity.query response.
 * 
 * @author auto create
...
public class AlipayCommerceNxactivityQueryResponse extends AlipayResponse {
	...
	private static final long serialVersionUID = 3824159395354211217L;
	...
	@ApiField("nx_activity_voucher_info")
	private List<NxActivityVoucherInfo> voucherList;
	...
	public void setVoucherList(List<NxActivityVoucherInfo> voucherList) {
		this.voucherList = voucherList;
	}
	public List<NxActivityVoucherInfo> getVoucherList( ) {
